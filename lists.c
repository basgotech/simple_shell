 ...
 * Return: size of list
 */
list_t *generate_node(list_t **head, const char *str, int num)
{
	list_t *new_head;
 ...
 * Return: size of list
 */
list_t *generate_node_end(list_t **head, const char *str, int num)
{
 ...
 * Return: size of list
 */
size_t show_string_list(const list_t *h)
{
	size_t i = 0;
 ...
 */
int erase_node_at_position(list_t **head, unsigned int index)
{
